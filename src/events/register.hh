...
namespace http
{
    ...
    public:
         ...
         */
        void unregister_ew(EventWatcher *watcher);
        ...
        /**
         * \brief Server-wide timeout values
         */
        std::optional<float> keep_alive = std::nullopt;
        std::optional<float> transaction = std::nullopt;
        std::optional<int> throughput_val = std::nullopt;
        std::optional<float> throughput_time = std::nullopt;
