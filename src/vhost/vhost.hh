...
namespace http
{
    ...
    public:
         ...
         */
        explicit VHost(const VHostConfig &vhost_config)
            : transaction_timer{}
            , conf_(vhost_config)
        {}
         ...
         */
        virtual void respond(Request &request, shared_socket sock) = 0;
        ...
        inline SSL_CTX *get_ssl_ctx_() const
        {
            return this->ssl_ctx_.get();
        }
        ...
        void client_sock_set(int client_sock);
    ...
    protected:
        ...
        virtual void respond_basic(Request &request, shared_socket sock) = 0;
    };
